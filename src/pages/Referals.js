     ...
     <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="carousel-caption d-none d-md-block">
          <h5>Je ne peux que vous recommandez Drucilla, qui a fait preuve d'autonomie et d'initiative quand on a travaillé ensemble en ce début d'année. Elle n'a peur ni de dire quand elle ne sait pas, ni de se mettre en danger en sortant de sa zone de confort. Alors ne manquez pas une opportunité de renforcer vos équipes avec elle ! Bonus : on a travaillé en remote, elle à Nantes, moi à Évian, sans aucun soucis !</h5>
          <p>Benoît BERAUD, Cloud Architect Freelance</p>
        </div>
      </div>
      <div class="carousel-item">
        <div class="carousel-caption d-none d-md-block">
          <h5>Drucilla Deroche est passionnée par le #Développement #Web et a aussi des compétences en informatique. Elle sait s'adapter, trouver des solutions et apprécie toujours donner un coup de main quand elle le peut !</h5>
          <p>Julie LEFEBVRE, Responsable d'école chez WebForce3</p>
        </div>
      </div>
      <div class="carousel-item">
        <div class="carousel-caption d-none d-md-block">
          <h5>Je ne peux que vous recommandez Drucilla, qui fait preuve d'autonomie et d'initiative dans son travail, et a parfaitement su s'intégrer dans l'équipe et apporter sa gaieté lorsqu'elle a travaillé au Chaudron.io !</h5>
